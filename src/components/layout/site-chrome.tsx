...
/**
 * Public-facing shell: header, footer, the WhatsApp button and analytics.
 *
 ...
 * That also keeps admin page views out of Tag Manager. Used by the `(site)`
 * route group and by the 404 page, which sits outside that group but should
 * still look (and be measured) like the website.
 */
